...
- **Modo de Compra por Defecto:** Elegí si los ítems nuevos se registran como **Normal** o **Favorito** directamente al comprarlos. Por defecto es Normal.
...
- **Default Purchase Mode:** Choose whether new items are saved as **Normal** or **Favorite** at the moment of purchase. Defaults to Normal.
